...
var (
	...
	autoInit    = flag.Bool("auto-init", true, "Pass true to create an initial commit with empty README.")
)
...
func main() {
	...
	listBranch(ctx, client, "abt-repo")
...
3. List of branches
4. commit code to a existing branch
5. commit code to a new branch
5. Create PR
